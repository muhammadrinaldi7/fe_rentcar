  ...
  return (
    <section className="py-2">
      <div className="flex flex-col justify-center items-center w-full">
        <div className="flex flex-col p-6 gap-4 bg-seccond-600 rounded-xl">
          <div className="flex flex-col lg:flex-row gap-4 lg:gap-32 items-center justify-between">
            <div className="flex flex-col">
              <h1 className="text-primary-500 text-x;">Our Service</h1>
              <p className="text-white text-4xl">
                Our Premier Service for your car rental needs
              </p>
            </div>
            <p className="text-sm text-seccond-400  lg:w-1/2 ">
          ...
          <div className="flex flex-col lg:flex-row gap-6">
            <div className="flex bg-slate-800 p-4 rounded-2xl flex-col basis-1/3 gap-4">
              <div className="flex justify-center">
                <div className="rounded-full p-2 bg-gray-600">
                  <div className="rounded-full bg-gray-500 px-3 py-2">
                    <FontAwesomeIcon
                      icon={faCar}
              ...
              <h1 className="text-lg text-white mt-3">Well-maintananed Cars</h1>
              <p className="text-sm text-seccond-400">
            ...
            <div className="flex bg-slate-800 p-4 rounded-2xl flex-col basis-1/3 gap-4">
              ...
              <h1 className="text-lg text-white mt-3">Secure Payments</h1>
              <p className="text-sm text-seccond-400">
            ...
            <div className="flex bg-slate-800 p-4 rounded-2xl flex-col basis-1/3 gap-4">
              ...
              <h1 className="text-lg text-white mt-3">24/7 Support</h1>
              <p className="text-sm text-seccond-400">
